...
export default function Orphanage() {
    ...
    return (
        <div id="page-orphanage">
            ...
            <main>
                <div className="orphanage-details">/map-marker.svg
                    ...
                    <div className="orphanage-details-content">
                        ...
                        <div className="map-container">
                            ...
                            <footer>
                                <a  target="_blank" rel="noopener noreferrer" href={`https://https://www.google.com/maps/dir/?api=16destination=${orphanage.latitude},${orphanage.latitude}`}>Ver rotas no Google Maps</a>
                            </footer>
                        </div>
